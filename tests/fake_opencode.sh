...
emit '{"type":"reasoning","timestamp":3,"sessionID":"ses_fake123","part":{"id":"prt_r1","messageID":"msg_1","sessionID":"ses_fake123","type":"reasoning","text":"let me check the scene"}}'
...
emit '{"type":"tool_use","timestamp":4,"sessionID":"ses_fake123","part":{"id":"prt_3b","messageID":"msg_1","sessionID":"ses_fake123","type":"tool","tool":"edit","callID":"call_2","state":{"status":"completed","input":{"filePath":"/proj/player.gd","oldString":"speed = 100","newString":"speed = 300"},"metadata":{},"output":"ok"}}}'
